    ...
    <div>
      ...
      <ul>
        {items.map((item) => (
          <li
            key={item.id}
            className="w-[98%] mx-auto shadow-md mb-4 p-3 rounded-xl bg-white grid grid-cols-2 justify-center  "
          >
            <div className="ml-10 flex justify-start gap-9 mb-2">
              <div>
                <img
                  src={urlFor(item.image).url()}
                  alt="product"
                  className="w-24 rounded-md border-2 border-gold-300"
                />
              </div>
              <div className=" self-center text-sm grid">
                ...
                <p>
                  Price:{" "}
                  <span className="text-gold-100 font-bold">N{item.price}</span>
                </p>
              </div>
            </div>
            <div className="justify-self-end self-center mr-10 text-sm font-bold grid place-items-center">
