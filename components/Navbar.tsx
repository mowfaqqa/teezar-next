          ...
          <div className=" flex justify-end">
            {!loggedUser ? (
              <button
                type="button"
                onClick={handleSignin}
                className=" text-white border-2 rounded font-medium px-3 text-sm py-1 tracking-widest hover:text-gold-100  hover:border-gold-100 transition-all duration-300 ease-linear"
              >
                Sign In
              </button>
            ) : (
